//---------------------------------------------------------------------
// <copyright file="BodyTranslationTest.cs" company=".NET Foundation">
...
namespace Microsoft.OData.Extensions.Migration.Tests
{
    ...
    using System.Net;
    using Xunit;
    using Microsoft.OData.Extensions.Migration.Tests.Mock;
    ...
    public class BodyTranslationTest : TestsServiceBase
    {
        ...
        {
            HttpResponseMessage response = await Get(OrdersBaseUrl + "/Microsoft.OData.Extensions.Migration.Tests.Mock.SpecialOrder");
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);
            string content = await response.Content.ReadAsStringAsync();
            Assert.Contains("Special Order1", content);
            Assert.DoesNotContain("Microsoft.OData.Extensions.Migration.Tests.Mock.Order", content);
        }
